...
export default function EditPostsPages() {
  const { id } = useParams();
  ...
  const EditPost = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setMessage("Error, cannot update data!");
      setShowModal(true);
    }
  };
    ...
    <div className="flex h-screen bg-white">
      ...
      <div className="flex flex-col flex-1">
        ...
        <div className="ml-64 overflow-y-auto p-6 mt-7">
          <h1 className="font-bold text-2xl text-slate-600">Form edit posts</h1>
